CREATE OR REPLACE PROCEDURE `median_company_10y_multipliers`()
BEGIN
	-- выполняем логирование процедуры
	set @startDaily := NOW();
    set @nameDaily := 'median_company_10y_multipliers';
    ...
    INSERT INTO median_company_10y_metrics (
    					company_id,
    					mkt_cap_median_10y,
						p_e_median_10y,
						p_s_median_10y,
						p_bv_median_10y,
						ev_ebitda_median_10y,
						roe_median_10y,
						ev_median_10y,
						ev_ebit_median_10y,
						p_fcf_median_10y,
						...
						ev_nopat_median_10y,
						ev_s_median_10y,
						net_debt_ebitda_median_10y,
						eps_median_10y,
						book_value_per_share_median_10y,
						dupont_median_10y,
						altman_model_median_10y,
						graham_median_10y,
						e_p_median_10y,
						free_cash_flow_yield_median_10y,
						roa_median_10y,
						roaa_median_10y,
						roae_median_10y,
						oroa_median_10y,
						...
						roic_median_10y,
						roce_median_10y,
						gross_margin_median_10y,
						ebitda_margin_median_10y,
						ebit_margin_median_10y,
						operating_margin_median_10y,
						pretax_margin_median_10y,
						net_margin_median_10y,
						net_debt_ebit_median_10y,
						net_debt_net_income_median_10y,
						net_debt_mcap_median_10y,
						net_debt_asset_median_10y,
						debt_asset_median_10y,
						net_debt_equity_median_10y,
						debt_equity_median_10y,
						long_term_debt_to_equity_median_10y,
						long_term_debt_to_nopat_median_10y,
						free_cash_flow_debt_median_10y,
						net_debt_oibda_median_10y,
						debt_ratio_median_10y,
						debt_to_equity_ratio_median_10y,
						current_ratio_median_10y,
						cash_ratio_median_10y,
						quick_ratio_median_10y,
						solvency_ratio_median_10y,
						asset_coverage_ratio_median_10y,
						capitalization_ratio_median_10y,
						inventory_turnover_median_10y,
						receivable_turnover_ratio_median_10y,
						accounts_payable_turnover_median_10y,
						cap_turnover_median_10y,
						working_cap_turnover_median_10y,
						asset_turnover_median_10y,
						fixed_assets_turnover_median_10y,
						inv_turnover_p_median_10y,
						p_of_repayment_median_10y,
						payables_repayment_p_median_10y,
						cap_turnover_p_median_10y,
						asset_turnover_p_median_10y,
						operating_cycle_median_10y,
						p_ncf_median_10y,
						p_cfo_median_10y,
						p_nwc_median_10y,
						capex_fcf_median_10y,
						capex_revenue_median_10y,
						ev_bv_median_10y,
						peg_median_10y,
						ros_median_10y,
						ev_ic_median_10y,
						interest_coverage_ratio_median_10y,
						debt_median_10y,
						net_debt_median_10y,
						oibda_median_10y,
						nopat_median_10y,
						excess_cash_median_10y,
						invested_capital_median_10y,
						employed_capital_median_10y,
						excess_cash_flow_median_10y,
						p_c_median_10y,
						fcf_margin_median_10y,
						croic_median_10y,
						croic_greenblatt_median_10y,
						oibda_margin_median_10y,
						graham_number_median_10y,
						netDebt_FCF_median_10y,
						pretax_roa_median_10y,
						pretax_roe_median_10y,
						debt_ebitda_median_10y,
						debt_FCF_median_10y,
						reinvestment_rate_median_10y,
						long_term_debt_to_asset_median_10y,
						ocfr_median_10y,
						capex_cfo_median_10y,
						capex_amortization_median_10y,
						revenue_growth_1y_median_10y,
						revenue_growth_3y_median_10y,
						revenue_growth_5y_median_10y,
						revenue_growth_10y_median_10y,
						revenue_cagr_3y_median_10y,
						revenue_cagr_5y_median_10y,
						revenue_cagr_10y_median_10y,
						ebitda_growth_1y_median_10y,
						ebitda_growth_3y_median_10y,
						ebitda_growth_5y_median_10y,
						ebitda_growth_10y_median_10y,
						ebitda_cagr_3y_median_10y,
						ebitda_cagr_5y_median_10y,
						ebitda_cagr_10y_median_10y,
						operatingIncome_growth_1y_median_10y,
						operatingIncome_growth_3y_median_10y,
						operatingIncome_growth_5y_median_10y,
						operatingIncome_growth_10y_median_10y,
						operatingIncome_cagr_3y_median_10y,
						operatingIncome_cagr_5y_median_10y,
						operatingIncome_cagr_10y_median_10y,
						netIncome_growth_1y_median_10y,
						netIncome_growth_3y_median_10y,
						netIncome_growth_5y_median_10y,
						netIncome_growth_10y_median_10y,
						netIncome_cagr_3y_median_10y,
						netIncome_cagr_5y_median_10y,
						netIncome_cagr_10y_median_10y,
						eps_growth_1y_median_10y,
						eps_growth_3y_median_10y,
						eps_growth_5y_median_10y,
						eps_growth_10y_median_10y,
						eps_cagr_3y_median_10y,
						eps_cagr_5y_median_10y,
						eps_cagr_10y_median_10y,
						debt_growth_1y_median_10y,
						debt_growth_3y_median_10y,
						debt_growth_5y_median_10y,
						debt_growth_10y_median_10y,
						netDebt_growth_1y_median_10y,
						netDebt_growth_3y_median_10y,
						netDebt_growth_5y_median_10y,
						netDebt_growth_10y_median_10y)
		SELECT 	t.*
		FROM (
			WITH ranked_data AS (
			...
			SELECT company_id,
							...
							ROUND(AVG(CASE WHEN rn_gross_margin = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN gross_margin END), 2) AS gross_margin_median_10y,
							ROUND(AVG(CASE WHEN rn_ebitda_margin = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN ebitda_margin END), 2) AS ebitda_margin_median_10y,
							ROUND(AVG(CASE WHEN rn_ebit_margin = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN ebit_margin END), 2) AS ebit_margin_median_10y,
							ROUND(AVG(CASE WHEN rn_operating_margin = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN operating_margin END), 2) AS operating_margin_median_10y,
							...
							ROUND(AVG(CASE WHEN rn_net_debt_ebit = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN net_debt_ebit END), 2) AS net_debt_ebit_median_10y,
							ROUND(AVG(CASE WHEN rn_net_debt_net_income = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN net_debt_net_income END), 2) AS net_debt_net_income_median_10y,
							ROUND(AVG(CASE WHEN rn_net_debt_mcap = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN net_debt_mcap END), 2) AS net_debt_mcap_median_10y,
							...
							ROUND(AVG(CASE WHEN rn_net_debt_equity = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN net_debt_equity END), 2) AS net_debt_equity_median_10y,
							ROUND(AVG(CASE WHEN rn_debt_equity = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN debt_equity END), 2) AS debt_equity_median_10y,
							ROUND(AVG(CASE WHEN rn_long_term_debt_to_equity = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN long_term_debt_to_equity END), 2) AS long_term_debt_to_equity_median_10y,
							ROUND(AVG(CASE WHEN rn_long_term_debt_to_nopat = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN long_term_debt_to_nopat END), 2) AS long_term_debt_to_nopat_median_10y,
							ROUND(AVG(CASE WHEN rn_free_cash_flow_debt = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN free_cash_flow_debt END), 2) AS free_cash_flow_debt_median_10y,
							...
							ROUND(AVG(CASE WHEN rn_debt_to_equity_ratio = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN debt_to_equity_ratio END), 2) AS debt_to_equity_ratio_median_10y,
							...
							ROUND(AVG(CASE WHEN rn_quick_ratio = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN quick_ratio END), 2) AS quick_ratio_median_10y,
							ROUND(AVG(CASE WHEN rn_solvency_ratio = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN solvency_ratio END), 2) AS solvency_ratio_median_10y,
							ROUND(AVG(CASE WHEN rn_asset_coverage_ratio = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN asset_coverage_ratio END), 2) AS asset_coverage_ratio_median_10y,
							ROUND(AVG(CASE WHEN rn_capitalization_ratio = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN capitalization_ratio END), 2) AS capitalization_ratio_median_10y,
							ROUND(AVG(CASE WHEN rn_inventory_turnover = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN inventory_turnover END), 2) AS inventory_turnover_median_10y,
							ROUND(AVG(CASE WHEN rn_receivable_turnover_ratio = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN receivable_turnover_ratio END), 2) AS receivable_turnover_ratio_median_10y,
							ROUND(AVG(CASE WHEN rn_accounts_payable_turnover = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN accounts_payable_turnover END), 2) AS accounts_payable_turnover_median_10y,
							ROUND(AVG(CASE WHEN rn_cap_turnover = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN cap_turnover END), 2) AS cap_turnover_median_10y,
							ROUND(AVG(CASE WHEN rn_working_cap_turnover = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN working_cap_turnover END), 2) AS working_cap_turnover_median_10y,
							ROUND(AVG(CASE WHEN rn_asset_turnover = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN asset_turnover END), 2) AS asset_turnover_median_10y,
							ROUND(AVG(CASE WHEN rn_fixed_assets_turnover = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN fixed_assets_turnover END), 2) AS fixed_assets_turnover_median_10y,
							ROUND(AVG(CASE WHEN rn_inv_turnover_p = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN inv_turnover_p END), 2) AS inv_turnover_p_median_10y,
							ROUND(AVG(CASE WHEN rn_p_of_repayment = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN p_of_repayment END), 2) AS p_of_repayment_median_10y,
							ROUND(AVG(CASE WHEN rn_payables_repayment_p = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN payables_repayment_p END), 2) AS payables_repayment_p_median_10y,
							ROUND(AVG(CASE WHEN rn_cap_turnover_p = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN cap_turnover_p END), 2) AS cap_turnover_p_median_10y,
							ROUND(AVG(CASE WHEN rn_asset_turnover_p = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN asset_turnover_p END), 2) AS asset_turnover_p_median_10y,
							...
							ROUND(AVG(CASE WHEN rn_excess_cash = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN excess_cash END), 2) AS excess_cash_median_10y,
							ROUND(AVG(CASE WHEN rn_invested_capital = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN invested_capital END), 2) AS invested_capital_median_10y,
							ROUND(AVG(CASE WHEN rn_employed_capital = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN employed_capital END), 2) AS employed_capital_median_10y,
							...
							ROUND(AVG(CASE WHEN rn_croic_greenblatt = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN croic_greenblatt END), 2) AS croic_greenblatt_median_10y,
							ROUND(AVG(CASE WHEN rn_oibda_margin = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN oibda_margin END), 2) AS oibda_margin_median_10y,
			                ROUND(AVG(CASE WHEN rn_graham_number = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN graham_number END), 2) AS graham_number_median_10y,
							...
							ROUND(AVG(CASE WHEN rn_reinvestment_rate = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN reinvestment_rate END), 2) AS reinvestment_rate_median_10y,
							...
							ROUND(AVG(CASE WHEN rn_capex_amortization = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN capex_amortization END), 2) AS capex_amortization_median_10y,
							ROUND(AVG(CASE WHEN rn_revenue_growth_1y = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN revenue_growth_1y END), 2) AS revenue_growth_1y_median_10y,
							ROUND(AVG(CASE WHEN rn_revenue_growth_3y = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN revenue_growth_3y END), 2) AS revenue_growth_3y_median_10y,
							ROUND(AVG(CASE WHEN rn_revenue_growth_5y = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN revenue_growth_5y END), 2) AS revenue_growth_5y_median_10y,
							ROUND(AVG(CASE WHEN rn_revenue_growth_10y = FLOOR((total_rows + 1) / 2) 
													...
													THEN revenue_growth_10y END), 2) AS revenue_growth_10y_median_10y,
							ROUND(AVG(CASE WHEN rn_revenue_cagr_3y = FLOOR((total_rows + 1) / 2) 
													...
													THEN revenue_cagr_3y END), 2) AS revenue_cagr_3y_median_10y,
							ROUND(AVG(CASE WHEN rn_revenue_cagr_5y = FLOOR((total_rows + 1) / 2) 
													...
													THEN revenue_cagr_5y END), 2) AS revenue_cagr_5y_median_10y,
							ROUND(AVG(CASE WHEN rn_revenue_cagr_10y = FLOOR((total_rows + 1) / 2) 
													...
													THEN revenue_cagr_10y END), 2) AS revenue_cagr_10y_median_10y,
							ROUND(AVG(CASE WHEN rn_ebitda_growth_1y = FLOOR((total_rows + 1) / 2) 
													...
													THEN ebitda_growth_1y END), 2) AS ebitda_growth_1y_median_10y,
							ROUND(AVG(CASE WHEN rn_ebitda_growth_3y = FLOOR((total_rows + 1) / 2) 
													...
													THEN ebitda_growth_3y END), 2) AS ebitda_growth_3y_median_10y,
							ROUND(AVG(CASE WHEN rn_ebitda_growth_5y = FLOOR((total_rows + 1) / 2) 
													...
													THEN ebitda_growth_5y END), 2) AS ebitda_growth_5y_median_10y,
							ROUND(AVG(CASE WHEN rn_ebitda_growth_10y = FLOOR((total_rows + 1) / 2) 
													...
													THEN ebitda_growth_10y END), 2) AS ebitda_growth_10y_median_10y,
							ROUND(AVG(CASE WHEN rn_ebitda_cagr_3y = FLOOR((total_rows + 1) / 2) 
													...
													THEN ebitda_cagr_3y END), 2) AS ebitda_cagr_3y_median_10y,
							ROUND(AVG(CASE WHEN rn_ebitda_cagr_5y = FLOOR((total_rows + 1) / 2) 
													...
													THEN ebitda_cagr_5y END), 2) AS ebitda_cagr_5y_median_10y,
							ROUND(AVG(CASE WHEN rn_ebitda_cagr_10y = FLOOR((total_rows + 1) / 2) 
													...
													THEN ebitda_cagr_10y END), 2) AS ebitda_cagr_10y_median_10y,
							ROUND(AVG(CASE WHEN rn_operatingIncome_growth_1y = FLOOR((total_rows + 1) / 2) 
													...
													THEN operatingIncome_growth_1y END), 2) AS operatingIncome_growth_1y_median_10y,
							ROUND(AVG(CASE WHEN rn_operatingIncome_growth_3y = FLOOR((total_rows + 1) / 2) 
													...
													THEN operatingIncome_growth_3y END), 2) AS operatingIncome_growth_3y_median_10y,
							ROUND(AVG(CASE WHEN rn_operatingIncome_growth_5y = FLOOR((total_rows + 1) / 2) 
													...
													THEN operatingIncome_growth_5y END), 2) AS operatingIncome_growth_5y_median_10y,
							ROUND(AVG(CASE WHEN rn_operatingIncome_growth_10y = FLOOR((total_rows + 1) / 2) 
													...
													THEN operatingIncome_growth_10y END), 2) AS operatingIncome_growth_10y_median_10y,
							ROUND(AVG(CASE WHEN rn_operatingIncome_cagr_3y = FLOOR((total_rows + 1) / 2) 
													...
													THEN operatingIncome_cagr_3y END), 2) AS operatingIncome_cagr_3y_median_10y,
							ROUND(AVG(CASE WHEN rn_operatingIncome_cagr_5y = FLOOR((total_rows + 1) / 2) 
													...
													THEN operatingIncome_cagr_5y END), 2) AS operatingIncome_cagr_5y_median_10y,
							ROUND(AVG(CASE WHEN rn_operatingIncome_cagr_10y = FLOOR((total_rows + 1) / 2) 
													...
													THEN operatingIncome_cagr_10y END), 2) AS operatingIncome_cagr_10y_median_10y,
							ROUND(AVG(CASE WHEN rn_netIncome_growth_1y = FLOOR((total_rows + 1) / 2) 
													...
													THEN netIncome_growth_1y END), 2) AS netIncome_growth_1y_median_10y,
							ROUND(AVG(CASE WHEN rn_netIncome_growth_3y = FLOOR((total_rows + 1) / 2) 
													...
													THEN netIncome_growth_3y END), 2) AS netIncome_growth_3y_median_10y,
							ROUND(AVG(CASE WHEN rn_netIncome_growth_5y = FLOOR((total_rows + 1) / 2) 
													...
													THEN netIncome_growth_5y END), 2) AS netIncome_growth_5y_median_10y,
							ROUND(AVG(CASE WHEN rn_netIncome_growth_10y = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN netIncome_growth_10y END), 2) AS netIncome_growth_10y_median_10y,
							ROUND(AVG(CASE WHEN rn_netIncome_cagr_3y = FLOOR((total_rows + 1) / 2) 
													...
													THEN netIncome_cagr_3y END), 2) AS netIncome_cagr_3y_median_10y,
							ROUND(AVG(CASE WHEN rn_netIncome_cagr_5y = FLOOR((total_rows + 1) / 2) 
													...
													THEN netIncome_cagr_5y END), 2) AS netIncome_cagr_5y_median_10y,
							ROUND(AVG(CASE WHEN rn_netIncome_cagr_10y = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN netIncome_cagr_10y END), 2) AS netIncome_cagr_10y_median_10y,
							ROUND(AVG(CASE WHEN rn_eps_growth_1y = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN eps_growth_1y END), 2) AS eps_growth_1y_median_10y,
							ROUND(AVG(CASE WHEN rn_eps_growth_3y = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN eps_growth_3y END), 2) AS eps_growth_3y_median_10y,
							ROUND(AVG(CASE WHEN rn_eps_growth_5y = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN eps_growth_5y END), 2) AS eps_growth_5y_median_10y,
							ROUND(AVG(CASE WHEN rn_eps_growth_10y = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN eps_growth_10y END), 2) AS eps_growth_10y_median_10y,
							ROUND(AVG(CASE WHEN rn_eps_cagr_3y = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN eps_cagr_3y END), 2) AS eps_cagr_3y_median_10y,
							ROUND(AVG(CASE WHEN rn_eps_cagr_5y = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN eps_cagr_5y END), 2) AS eps_cagr_5y_median_10y,
							ROUND(AVG(CASE WHEN rn_eps_cagr_10y = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN eps_cagr_10y END), 2) AS eps_cagr_10y_median_10y,
							ROUND(AVG(CASE WHEN rn_debt_growth_1y = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN debt_growth_1y END), 2) AS debt_growth_1y_median_10y,
							ROUND(AVG(CASE WHEN rn_debt_growth_3y = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN debt_growth_3y END), 2) AS debt_growth_3y_median_10y,
							ROUND(AVG(CASE WHEN rn_debt_growth_5y = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN debt_growth_5y END), 2) AS debt_growth_5y_median_10y,
							ROUND(AVG(CASE WHEN rn_debt_growth_10y = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN debt_growth_10y END), 2) AS debt_growth_10y_median_10y,
							ROUND(AVG(CASE WHEN rn_netDebt_growth_1y = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN netDebt_growth_1y END), 2) AS netDebt_growth_1y_median_10y,
							ROUND(AVG(CASE WHEN rn_netDebt_growth_3y = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN netDebt_growth_3y END), 2) AS netDebt_growth_3y_median_10y,
							ROUND(AVG(CASE WHEN rn_netDebt_growth_5y = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN netDebt_growth_5y END), 2) AS netDebt_growth_5y_median_10y,
							ROUND(AVG(CASE WHEN rn_netDebt_growth_10y = FLOOR((total_rows + 1) / 2) 
									                ...
									                THEN netDebt_growth_10y END), 2) AS netDebt_growth_10y_median_10y
			FROM ranked_data
			GROUP BY company_id
			ORDER BY company_id
			) t
			ON DUPLICATE KEY UPDATE mkt_cap_median_10y = t.mkt_cap_median_10y,
									p_e_median_10y = t.p_e_median_10y,
									p_s_median_10y = t.p_s_median_10y,
									p_bv_median_10y = t.p_bv_median_10y,
									ev_ebitda_median_10y = t.ev_ebitda_median_10y,
									roe_median_10y = t.roe_median_10y,
									ev_median_10y = t.ev_median_10y,
									ev_ebit_median_10y = t.ev_ebit_median_10y,
									p_fcf_median_10y = t.p_fcf_median_10y,
									ev_fcf_median_10y = t.ev_fcf_median_10y,
									ev_cfo_median_10y = t.ev_cfo_median_10y,
									ev_nopat_median_10y = t.ev_nopat_median_10y,
									ev_s_median_10y = t.ev_s_median_10y,
									net_debt_ebitda_median_10y = t.net_debt_ebitda_median_10y,
									eps_median_10y = t.eps_median_10y,
									book_value_per_share_median_10y = t.book_value_per_share_median_10y,
									dupont_median_10y = t.dupont_median_10y,
									altman_model_median_10y = t.altman_model_median_10y,
									graham_median_10y = t.graham_median_10y,
									e_p_median_10y = t.e_p_median_10y,
									free_cash_flow_yield_median_10y = t.free_cash_flow_yield_median_10y,
									roa_median_10y = t.roa_median_10y,
									roaa_median_10y = t.roaa_median_10y,
									roae_median_10y = t.roae_median_10y,
									oroa_median_10y = t.oroa_median_10y,
									rona_median_10y = t.rona_median_10y,
									rooa_median_10y = t.rooa_median_10y,
									roic_median_10y = t.roic_median_10y,
									roce_median_10y = t.roce_median_10y,
									gross_margin_median_10y = t.gross_margin_median_10y,
									ebitda_margin_median_10y = t.ebitda_margin_median_10y,
									ebit_margin_median_10y = t.ebit_margin_median_10y,
									operating_margin_median_10y = t.operating_margin_median_10y,
									pretax_margin_median_10y = t.pretax_margin_median_10y,
									net_margin_median_10y = t.net_margin_median_10y,
									net_debt_ebit_median_10y = t.net_debt_ebit_median_10y,
									net_debt_net_income_median_10y = t.net_debt_net_income_median_10y,
									net_debt_mcap_median_10y = t.net_debt_mcap_median_10y,
									net_debt_asset_median_10y = t.net_debt_asset_median_10y,
									debt_asset_median_10y = t.debt_asset_median_10y,
									net_debt_equity_median_10y = t.net_debt_equity_median_10y,
									debt_equity_median_10y = t.debt_equity_median_10y,
									long_term_debt_to_equity_median_10y = t.long_term_debt_to_equity_median_10y,
									long_term_debt_to_nopat_median_10y = t.long_term_debt_to_nopat_median_10y,
									free_cash_flow_debt_median_10y = t.free_cash_flow_debt_median_10y,
									net_debt_oibda_median_10y = t.net_debt_oibda_median_10y,
									debt_ratio_median_10y = t.debt_ratio_median_10y,
									debt_to_equity_ratio_median_10y = t.debt_to_equity_ratio_median_10y,
									current_ratio_median_10y = t.current_ratio_median_10y,
									cash_ratio_median_10y = t.cash_ratio_median_10y,
									quick_ratio_median_10y = t.quick_ratio_median_10y,
									solvency_ratio_median_10y = t.solvency_ratio_median_10y,
									asset_coverage_ratio_median_10y = t.asset_coverage_ratio_median_10y,
									capitalization_ratio_median_10y = t.capitalization_ratio_median_10y,
									inventory_turnover_median_10y = t.inventory_turnover_median_10y,
									receivable_turnover_ratio_median_10y = t.receivable_turnover_ratio_median_10y,
									accounts_payable_turnover_median_10y = t.accounts_payable_turnover_median_10y,
									cap_turnover_median_10y = t.cap_turnover_median_10y,
									working_cap_turnover_median_10y = t.working_cap_turnover_median_10y,
									asset_turnover_median_10y = t.asset_turnover_median_10y,
									fixed_assets_turnover_median_10y = t.fixed_assets_turnover_median_10y,
									inv_turnover_p_median_10y = t.inv_turnover_p_median_10y,
									p_of_repayment_median_10y = t.p_of_repayment_median_10y,
									payables_repayment_p_median_10y = t.payables_repayment_p_median_10y,
									cap_turnover_p_median_10y = t.cap_turnover_p_median_10y,
									asset_turnover_p_median_10y = t.asset_turnover_p_median_10y,
									operating_cycle_median_10y = t.operating_cycle_median_10y,
									p_ncf_median_10y = t.p_ncf_median_10y,
									p_cfo_median_10y = t.p_cfo_median_10y,
									p_nwc_median_10y = t.p_nwc_median_10y,
									capex_fcf_median_10y = t.capex_fcf_median_10y,
									capex_revenue_median_10y = t.capex_revenue_median_10y,
									ev_bv_median_10y = t.ev_bv_median_10y,
									peg_median_10y = t.peg_median_10y,
									ros_median_10y = t.ros_median_10y,
									ev_ic_median_10y = t.ev_ic_median_10y,
									interest_coverage_ratio_median_10y = t.interest_coverage_ratio_median_10y,
									debt_median_10y = t.debt_median_10y,
									net_debt_median_10y = t.net_debt_median_10y,
									oibda_median_10y = t.oibda_median_10y,
									nopat_median_10y = t.nopat_median_10y,
									excess_cash_median_10y = t.excess_cash_median_10y,
									invested_capital_median_10y = t.invested_capital_median_10y,
									employed_capital_median_10y = t.employed_capital_median_10y,
									excess_cash_flow_median_10y = t.excess_cash_flow_median_10y,
									p_c_median_10y = t.p_c_median_10y,
									fcf_margin_median_10y = t.fcf_margin_median_10y,
									croic_median_10y = t.croic_median_10y,
									croic_greenblatt_median_10y = t.croic_greenblatt_median_10y,
									oibda_margin_median_10y = t.oibda_margin_median_10y,
									graham_number_median_10y = t.graham_number_median_10y,
									netDebt_FCF_median_10y = t.netDebt_FCF_median_10y,
									pretax_roa_median_10y = t.pretax_roa_median_10y,
									pretax_roe_median_10y = t.pretax_roe_median_10y,
									debt_ebitda_median_10y = t.debt_ebitda_median_10y,
									debt_FCF_median_10y = t.debt_FCF_median_10y,
									reinvestment_rate_median_10y = t.reinvestment_rate_median_10y,
									long_term_debt_to_asset_median_10y = t.long_term_debt_to_asset_median_10y,
									ocfr_median_10y = t.ocfr_median_10y,
									capex_cfo_median_10y = t.capex_cfo_median_10y,
									capex_amortization_median_10y = t.capex_amortization_median_10y,
									revenue_growth_1y_median_10y = t.revenue_growth_1y_median_10y,
									revenue_growth_3y_median_10y = t.revenue_growth_3y_median_10y,
									revenue_growth_5y_median_10y = t.revenue_growth_5y_median_10y,
									revenue_growth_10y_median_10y = t.revenue_growth_10y_median_10y,
									revenue_cagr_3y_median_10y = t.revenue_cagr_3y_median_10y,
									revenue_cagr_5y_median_10y = t.revenue_cagr_5y_median_10y,
									revenue_cagr_10y_median_10y = t.revenue_cagr_10y_median_10y,
									ebitda_growth_1y_median_10y = t.ebitda_growth_1y_median_10y,
									ebitda_growth_3y_median_10y = t.ebitda_growth_3y_median_10y,
									ebitda_growth_5y_median_10y = t.ebitda_growth_5y_median_10y,
									ebitda_growth_10y_median_10y = t.ebitda_growth_10y_median_10y,
									ebitda_cagr_3y_median_10y = t.ebitda_cagr_3y_median_10y,
									ebitda_cagr_5y_median_10y = t.ebitda_cagr_5y_median_10y,
									ebitda_cagr_10y_median_10y = t.ebitda_cagr_10y_median_10y,
									operatingIncome_growth_1y_median_10y = t.operatingIncome_growth_1y_median_10y,
									operatingIncome_growth_3y_median_10y = t.operatingIncome_growth_3y_median_10y,
									operatingIncome_growth_5y_median_10y = t.operatingIncome_growth_5y_median_10y,
									operatingIncome_growth_10y_median_10y = t.operatingIncome_growth_10y_median_10y,
									operatingIncome_cagr_3y_median_10y = t.operatingIncome_cagr_3y_median_10y,
									operatingIncome_cagr_5y_median_10y = t.operatingIncome_cagr_5y_median_10y,
									operatingIncome_cagr_10y_median_10y = t.operatingIncome_cagr_10y_median_10y,
									netIncome_growth_1y_median_10y = t.netIncome_growth_1y_median_10y,
									netIncome_growth_3y_median_10y = t.netIncome_growth_3y_median_10y,
									netIncome_growth_5y_median_10y = t.netIncome_growth_5y_median_10y,
									netIncome_growth_10y_median_10y = t.netIncome_growth_10y_median_10y,
									netIncome_cagr_3y_median_10y = t.netIncome_cagr_3y_median_10y,
									netIncome_cagr_5y_median_10y = t.netIncome_cagr_5y_median_10y,
									netIncome_cagr_10y_median_10y = t.netIncome_cagr_10y_median_10y,
									eps_growth_1y_median_10y = t.eps_growth_1y_median_10y,
									eps_growth_3y_median_10y = t.eps_growth_3y_median_10y,
									eps_growth_5y_median_10y = t.eps_growth_5y_median_10y,
									eps_growth_10y_median_10y = t.eps_growth_10y_median_10y,
									eps_cagr_3y_median_10y = t.eps_cagr_3y_median_10y,
									eps_cagr_5y_median_10y = t.eps_cagr_5y_median_10y,
									eps_cagr_10y_median_10y = t.eps_cagr_10y_median_10y,
									debt_growth_1y_median_10y = t.debt_growth_1y_median_10y,
									debt_growth_3y_median_10y = t.debt_growth_3y_median_10y,
									debt_growth_5y_median_10y = t.debt_growth_5y_median_10y,
									debt_growth_10y_median_10y = t.debt_growth_10y_median_10y,
									netDebt_growth_1y_median_10y = t.netDebt_growth_1y_median_10y,
									netDebt_growth_3y_median_10y = t.netDebt_growth_3y_median_10y,
									netDebt_growth_5y_median_10y = t.netDebt_growth_5y_median_10y,
									netDebt_growth_10y_median_10y = t.netDebt_growth_10y_median_10y;
...
truncate table median_company_10y_metrics;