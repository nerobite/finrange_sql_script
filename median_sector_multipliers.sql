...
BEGIN
	...
	FROM (
			WITH ranked_data AS (
				SELECT ham.company_id, ham.period_end_date, c.sector_id, c.exchange_id,
					   ...
					   capex_cfo,
					   capex_amortization,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by mkt_cap) as rn_mkt_cap,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by p_e) as rn_p_e,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by p_s) as rn_p_s,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by p_bv) as rn_p_bv,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by ev_ebitda) as rn_ev_ebitda,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by roe) as rn_roe,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by ev) as rn_ev,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by ev_ebit) as rn_ev_ebit,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by p_fcf) as rn_p_fcf,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by ev_fcf) as rn_ev_fcf,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by ev_cfo) as rn_ev_cfo,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by ev_nopat) as rn_ev_nopat,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by ev_s) as rn_ev_s,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by net_debt_ebitda) as rn_net_debt_ebitda,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by eps) as rn_eps,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by book_value_per_share) as rn_book_value_per_share,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by dupont) as rn_dupont,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by altman_model) as rn_altman_model,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by graham) as rn_graham,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by e_p) as rn_e_p,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by free_cash_flow_yield) as rn_free_cash_flow_yield,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by roa) as rn_roa,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by roaa) as rn_roaa,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by roae) as rn_roae,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by oroa) as rn_oroa,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by rona) as rn_rona,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by rooa) as rn_rooa,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by roic) as rn_roic,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by roce) as rn_roce,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by gross_margin) as rn_gross_margin,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by ebitda_margin) as rn_ebitda_margin,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by ebit_margin) as rn_ebit_margin,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by operating_margin) as rn_operating_margin,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by pretax_margin) as rn_pretax_margin,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by net_margin) as rn_net_margin,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by net_debt_ebit) as rn_net_debt_ebit,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by net_debt_net_income) as rn_net_debt_net_income,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by net_debt_mcap) as rn_net_debt_mcap,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by net_debt_asset) as rn_net_debt_asset,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by debt_asset) as rn_debt_asset,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by net_debt_equity) as rn_net_debt_equity,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by debt_equity) as rn_debt_equity,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by long_term_debt_to_equity) as rn_long_term_debt_to_equity,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by long_term_debt_to_nopat) as rn_long_term_debt_to_nopat,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by free_cash_flow_debt) as rn_free_cash_flow_debt,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by net_debt_oibda) as rn_net_debt_oibda,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by debt_ratio) as rn_debt_ratio,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by debt_to_equity_ratio) as rn_debt_to_equity_ratio,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by current_ratio) as rn_current_ratio,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by cash_ratio) as rn_cash_ratio,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by quick_ratio) as rn_quick_ratio,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by solvency_ratio) as rn_solvency_ratio,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by asset_coverage_ratio) as rn_asset_coverage_ratio,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by capitalization_ratio) as rn_capitalization_ratio,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by inventory_turnover) as rn_inventory_turnover,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by receivable_turnover_ratio) as rn_receivable_turnover_ratio,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by accounts_payable_turnover) as rn_accounts_payable_turnover,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by cap_turnover) as rn_cap_turnover,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by working_cap_turnover) as rn_working_cap_turnover,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by asset_turnover) as rn_asset_turnover,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by fixed_assets_turnover) as rn_fixed_assets_turnover,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by inv_turnover_p) as rn_inv_turnover_p,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by p_of_repayment) as rn_p_of_repayment,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by payables_repayment_p) as rn_payables_repayment_p,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by cap_turnover_p) as rn_cap_turnover_p,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by asset_turnover_p) as rn_asset_turnover_p,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by operating_cycle) as rn_operating_cycle,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by p_ncf) as rn_p_ncf,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by p_cfo) as rn_p_cfo,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by p_nwc) as rn_p_nwc,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by capex_fcf) as rn_capex_fcf,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by capex_revenue) as rn_capex_revenue,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by ev_bv) as rn_ev_bv,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by peg) as rn_peg,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by ros) as rn_ros,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by ev_ic) as rn_ev_ic,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by interest_coverage_ratio) as rn_interest_coverage_ratio,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by debt) as rn_debt,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by net_debt) as rn_net_debt,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by oibda) as rn_oibda,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by nopat) as rn_nopat,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by excess_cash) as rn_excess_cash,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by invested_capital) as rn_invested_capital,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by employed_capital) as rn_employed_capital,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by excess_cash_flow) as rn_excess_cash_flow,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by p_c) as rn_p_c,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by fcf_margin) as rn_fcf_margin,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by croic) as rn_croic,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by croic_greenblatt) as rn_croic_greenblatt,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by oibda_margin) as rn_oibda_margin,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by graham_number) as rn_graham_number,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by netDebt_FCF) as rn_netDebt_FCF,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by pretax_roa) as rn_pretax_roa,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by pretax_roe) as rn_pretax_roe,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by debt_ebitda) as rn_debt_ebitda,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by debt_FCF) as rn_debt_FCF,						
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by reinvestment_rate) as rn_reinvestment_rate,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by long_term_debt_to_asset) as rn_long_term_debt_to_asset,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by ocfr) as rn_ocfr,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by capex_cfo) as rn_capex_cfo,
						ROW_NUMBER() over(PARTITION by period_end_date, c.sector_id, c.exchange_id order by capex_amortization) as rn_capex_amortization,
			...
			ORDER BY sector_id, exchange_id, period_end_date
			) t
   ...
   -- заносим данные в таблицу 
	...
	FROM (
			WITH ranked_data AS (
				SELECT lm.company_id, lm.end_date, c.sector_id, c.exchange_id,
			           mkt_cap,
			           p_e,
			           p_s,
			           p_bv,
...
truncate table median_sector_metrics;
